  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-16">
      ...
      <p className="mt-2 text-sm text-charcoal/60">
        Демо-аккаунты: <code className="rounded bg-sand px-1">buyer@altdi.ru</code>,{" "}
        <code className="rounded bg-sand px-1">maria@altdi.ru</code>,{" "}
        <code className="rounded bg-sand px-1">admin@altdi.ru</code> — пароль{" "}
